        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-9 h-9 rounded-full bg-secondary-foreground/8 flex items-center justify-center text-secondary-foreground/50 hover:bg-primary/15 hover:text-primary transition-colors duration-300"
            >
